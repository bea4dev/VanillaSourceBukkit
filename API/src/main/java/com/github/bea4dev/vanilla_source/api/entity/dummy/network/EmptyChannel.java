package com.github.bea4dev.vanilla_source.api.entity.dummy.network;
...
public class EmptyChannel extends AbstractChannel {
    ...
    public EmptyChannel(Channel parent) {super(parent);}
    ...
    @Override
    protected boolean isCompatible(EventLoop arg0) {return true;}
    ...
    @Override
    public ChannelMetadata metadata() {return new ChannelMetadata(true);}
