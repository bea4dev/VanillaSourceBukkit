...
import com.github.bea4dev.vanilla_source.nms.v1_21_R4.entity.EntityManager;
import com.github.bea4dev.vanilla_source.nms.v1_21_R4.packet.PacketManager;
...
public class NMSHandler implements INMSHandler {
    ...
    public void setDefaultBiomeData(BiomeDataContainer container) {
        ...
        MappedRegistry<Biome> registryWritable = (MappedRegistry<Biome>) dedicatedServer.registryAccess().lookup(Registries.BIOME).orElseThrow();
        Biome forestBiome = registryWritable.getValueOrThrow(oldKey);
    ...
    public void disableVanillaBGM() {
        ...
        for (var biome : org.bukkit.block.Biome.values()) {
            ...
            var nmsBiome = registryWritable.getValueOrThrow(key);
    ...
    public Object createTeleportPacket(Object iEntity) {
        ...
        return new ClientboundTeleportEntityPacket(entity.getId(), PositionMoveRotation.of(entity), Relative.ALL, true);
    }

    @Override
    public Object createTeleportPacketWithPosition(Object iEntity, double x, double y, double z) {
        var entity = (Entity) iEntity;
        var packet = new ClientboundTeleportEntityPacket(entity.getId(), PositionMoveRotation.of(entity), Relative.ALL, true);
        try {
